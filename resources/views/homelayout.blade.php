...
<!-- Mirrored from nahartheme.com/tf/chaffer-preview/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Aug 2018 14:36:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>E-shopbd||Online Shop</title>
    ...
    <link rel="stylesheet" href="{{asset('home/lib/css/nivo-slider.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{asset('home/lib/css/preview.css')}}" type="text/css" media="screen" />
...
<body>
                                ...
                                <ul>
                                    <li>
                                        <div class="cart-img-price">
                                            <div class="cart-img">
                                                <a href="#"><img src="home/assets/img/cart/1.jpg" alt="" /></a>
                                            </div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="mega-position"><a href="shop-page.html">Shop </a>
                                            <div class="mega-menu mega-4-colm">
                                                ...
                                                <ul>
                                                    <li class="menu-img">
                                                        <a href="shop-page.html"><img src="home/assets/img/shop/1.jpg" alt=""></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="footer-widget mb-30">
                            <div class="footer-logo">
                                <a href="index.html">
                                        <img src="home/assets/img/logo/logo-black.png" alt="">
                                    </a>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="copyright">
                            <p>
                                Copyright © 2018
                                <a href="#">themedream1</a> . All Rights Reserved.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="quick-image">
                                                    <div class="single-quick-image tab-content text-center">
                                                        <div class="tab-pane  fade in active" id="sin-pro-1">
                                                            <img src="home/assets/img/shop/q1.jpg" alt="" />
                                                        </div>
                                                        <div class="tab-pane fade in" id="sin-pro-2">
                                                            <img src="home/assets/img/shop/q2.jpg" alt="" />
                                                        </div>
                                                        <div class="tab-pane fade in" id="sin-pro-3">
                                                            <img src="home/assets/img/shop/q3.jpg" alt="" />
                                                        </div>
                                                        <div class="tab-pane fade in" id="sin-pro-4">
                                                            <img src="home/assets/img/shop/q4.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="quick-thumb">
                                                        <div class="nav nav-tabs">
                                                            <ul>
                                                                <li><a data-toggle="tab" href="#sin-pro-1"> <img src="home/assets/img/shop/q1.jpg" alt="quick view" /> </a></li>
                                                                <li><a data-toggle="tab" href="#sin-pro-2"> <img src="home/assets/img/shop/q2.jpg" alt="quick view" /> </a></li>
                                                                <li><a data-toggle="tab" href="#sin-pro-3"> <img src="home/assets/img/shop/q3.jpg" alt="quick view" /> </a></li>
                                                                <li><a data-toggle="tab" href="#sin-pro-4"> <img src="home/assets/img/shop/q4.jpg" alt="quick view" /> </a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <!-- all js here -->
    <script src="{{asset('home/assets/js/vendor/jquery-1.12.0.min.js')}}"></script>
    ...
    <script src="{{asset('home/lib/js/jquery.nivo.slider.js')}}"></script>
    <script src="{{asset('home/lib/home.js')}}"></script>
